...
1. **Temporal depth** - BloodHound provides a point-in-time graph snapshot. ADVulture fuses 30-90 days of authentication and authorization event logs to produce empirically weighted edges based on *actual observed behavior*, not theoretical topology alone.
